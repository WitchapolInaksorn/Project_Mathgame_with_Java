 ...
 * @author User
 */
public class calNumberJFrame4 extends javax.swing.JFrame {

    /**
     * Creates new form calNumberJFrame4
     */
    public calNumberJFrame4() {
        initComponents();
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                        ...
                        .addGap(259, 259, 259))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                        .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(139, 139, 139))))
        );
 ...
 calculateNumber c = new calculateNumber();
    private void jinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jinputActionPerformed
        ...
        if(isNumeric(input))
        {
            ...
            else
            {
                ...
                JOptionPane.showMessageDialog(this,"Your score : 3");
                setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calNumberJFrame4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
