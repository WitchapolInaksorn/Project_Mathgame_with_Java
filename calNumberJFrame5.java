 ...
 * @author User
 */
public class calNumberJFrame5 extends javax.swing.JFrame {

    /**
     * Creates new form calNumberJFrame5
     */
    public calNumberJFrame5() {
        initComponents();
        jLabel29.setText(randomNumberStr1 + " ^ " + " 2 " + " *  " + randomNumberStr2 + " - " + " (" + randomNumberStr3  + " + " + randomNumberStr4 + " % " + randomNumberStr5 + ") "
        +" % "+ randomNumberStr6 +" = " + " ?" );
    }
        ...
        String randomNumberStr5 = String.valueOf(randomNumber5);
        String randomNumberStr6 = String.valueOf(randomNumber6);
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
 ...
 calculateNumber c = new calculateNumber();
    private void jinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jinputActionPerformed
        ...
        c.number1 = randomNumber1*randomNumber1;
        c.number2 = randomNumber2;
        c.number3 = randomNumber3+(randomNumber4%randomNumber5);
        c.number4 = randomNumber6;
        ...
        if(isNumeric(input))
        {
            if(input.equals(strResult))
            {
                ...
                JOptionPane.showMessageDialog(this,"You got score : 5/5");
                setVisible(false);
            ...
            else
            {
                ...
                JOptionPane.showMessageDialog(this,"Your score : 4");
                setVisible(false);
                new Homepage().setVisible(true);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calNumberJFrame5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calNumberJFrame5().setVisible(true);
            }
        });
    }
